...
| [`design-decisions.md`](design-decisions.md) | Settled questions, owner decisions, future plans (from the original handoff). Includes the **grouping / family model**: the family score (built 2026-09-05) and the **family chip on a row** (built 2026-09-07) — what each answers, what each costs, and why the chip reuses `ROOT_GROUP_CTE` rather than restating the rule |
