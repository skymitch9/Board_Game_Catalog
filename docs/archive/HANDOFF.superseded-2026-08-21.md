> ⚠️ **SUPERSEDED 2026-08-21.** This file was split per estate DOCS_STANDARD into:
>
> - [`../TODO.md`](../TODO.md) — open/undeployed items
> - [`../DONE.md`](../DONE.md) — dated archive of finished work, newest first
> - [`../info/gotchas.md`](../info/gotchas.md) — traps found the hard way
> - [`../info/system-reference.md`](../info/system-reference.md) — deployment state, repo layout, commands
> - [`../info/design-decisions.md`](../info/design-decisions.md) — settled questions, plans, rationale
>
> **Do not edit this file.** It is kept as a point-in-time snapshot.
